...
- When AI creates or edits code, documentation, commits, the pull request body, or review replies, add the `ai-generated` label when the repository provides it and fill `AI usage/prompt(s) (if applicable)`.
